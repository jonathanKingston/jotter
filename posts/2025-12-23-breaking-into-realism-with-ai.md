...
My good pal [David Burns](https://www.theautomatedtester.co.uk/) talks about the *"force multiplier"* effect that AI can create for those with expertise.
...
My expectation is that staff engineers should be helping juniors build those verification skills by adding guardrails so AI assists rather than replaces judgment.
...
Cursor cloud agents help here. With the monorepo that has all our codebases on it, I can jot ideas or ask questions from my phone while on the move. By the time I'm back at my desk, there's a list of outputs to review like a todo list. Thinking happens in the gaps; verification happens when I have focus.
...
Do I think is better than human review? It depends, a well focused human that has endless time will likely be better. That simply isn't feasible for all tasks.
...
Bugbot fits well here. It works across all time zones, doesn't get tired, and catches the small things humans skim past on a second look. It can replace the follow-up human review entirely. Not because it's smarter, but because it's more consistent at a task that was already getting short-changed.
